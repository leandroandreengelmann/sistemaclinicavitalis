...
export default function DoctorPerformance({ 
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <h2 className="text-xl font-semibold text-gray-800 mb-4">Desempenho dos Médicos</h2>
      ...
      {sortedDoctors.length === 0 ? (
        <div className="text-center py-8">
          ...
          <p className="mt-2 text-gray-500">Nenhum dado disponível para este período.</p>
        </div>
      ) : (
            ...
            return (
              <div key={doctorId}>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-sm font-medium text-gray-500">{count} consultas</span>
                </div>
